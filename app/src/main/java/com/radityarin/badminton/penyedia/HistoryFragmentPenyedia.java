...
public class HistoryFragmentPenyedia extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_history_penyedia, container, false);
        ...
        sewaRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dt : dataSnapshot.getChildren()) {
                    ...
                    if (Objects.requireNonNull(mSewa).getIdlapangan().equals(auth.getUid()) && (mSewa.getStatussewa().equalsIgnoreCase("Pesanan selesai") || mSewa.getStatussewa().equalsIgnoreCase("Jam tidak tersedia"))) {
                        listsewa.add(mSewa);
                    }
                }
